...
function create_search_request(Currency, res){
	const search_endpoint= 'https://v6.exchangerate-api.com/v6/API_KEY/enriched/USD/'+Currency;
...
function create_search_request2(code,currency, conversion, res){
	const search_endpoint2= 'https://calendarific.com/api/v2/holidays?&api_key=API_KEY&country='+code+'&year=2022';
